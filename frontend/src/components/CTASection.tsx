  ...
  return (
    <section className="bg-brand-bgLight py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="section-title mb-6">Conquiste seu sorriso dos sonhos com um protocolo padrão ouro</h2>
        <p className="text-brand-muted font-sans text-base leading-relaxed mb-10">
          É cuidado, transformação e reencontro com a sua melhor versão. Agende sua avaliação e descubra
          como transformar seu sorriso com segurança e previsibilidade.
        </p>
        <a
          href={WHATSAPP_URL}
          target="_blank"
